...
EDIT: sometimes handlers and routes are in the same file, I have found this to be a pretty idea for typescripts, especially with fastify where if you use their typebox-providers, you get automatic type inference for \`request\` and \`reply\`.
