...
For Nand flash in particular, LittleFS has really poor write performance after a sync. See [LittleFS Nand Flash Optimization](@/notes/20260607181715-littlefs_nand_flash_optimization.md)


## References {#references}

-   [Nand flash addressing](https://docs.altera.com/r/docs/848530/25.3/hard-processor-system-technical-reference-manual-agilextm-3-socs/nand-flash-addressing-and-data-layout)
