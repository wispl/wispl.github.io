...
Databases are kind of tricky to do with Kubernetes, since they are really stateful. Although it is much easier to work with databases now if you have operators like PostreSQL operators which can automate replica set creation along with backups. The backups portion is really the big one. See [Kubernetes Database Backups](@/notes/20260607190721-kubernetes_database_backups.md) for manual backups without operators.


## Container Configurations {#container-configurations}


### [Kubernetes CPU and Memory Limits](@/notes/20260801193422-kubernetes_cpu_and_memory_limits.md) {#kubernetes-cpu-and-memory-limits--20260801193422-kubernetes-cpu-and-memory-limits-dot-md}


### [Kubernetes Network Policy](@/notes/20260801195006-kubernetes_network_policy.md) {#kubernetes-network-policy--20260801195006-kubernetes-network-policy-dot-md}
