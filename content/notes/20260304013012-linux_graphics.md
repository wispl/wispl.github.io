...
1.  graphics api: [Vulkan](@/notes/20260304015947-vulkan.md), [OpenGL](@/notes/20260304015540-opengl.md), etc...
...
[Wayland](@/notes/20260304013207-wayland.md) can use software rendering or hardware rendering, using dma-buf, for
